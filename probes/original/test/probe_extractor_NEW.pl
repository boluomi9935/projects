...
my $max_packet_size = 3_000_000; # max_insertion_size in mysql configuration (in bytes)
...
my $SQLinsertComplete1   = "INSERT INTO complete  (idOrganism, startLig, startM13, endM13, strand, chromossome, derivated, sequenceLig, sequenceLigGc, sequenceLigTm, sequenceM13, sequenceM13Gc, sequenceM13Tm, sequence, sequenceGc, sequenceTm, ligant)  VALUES ";
